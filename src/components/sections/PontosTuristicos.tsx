              ...
              <Card className="flex h-full flex-col">
                ...
                <CardBody className="flex min-h-0 flex-1 flex-col gap-3">
                  ...
                  <a
                    ...
                    className="mt-auto inline-flex items-center gap-1 text-sm font-semibold uppercase tracking-wider text-canastra-green-700 transition-colors hover:text-canastra-gold-500"
                  >
                    Veja mais
